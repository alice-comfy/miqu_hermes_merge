...
"""
##MODIFIED FROM https://github.com/ymcui/Chinese-LLaMA-Alpaca mergescript. 
## I had to hard code token count, that may be causing some issues.
import argparse
import json
import os
import gc
...
num_shards_of_models = {'7B': 1, '13B': 2, '33B': 4, '70B': 8}
params_of_models = {
    '7B':
        {
        "dim": 4096,
...
if __name__=='__main__':
    ...
    for lora_index, lora_model_path in enumerate(lora_model_paths):
        ...
        if model_vocab_size != len(tokenizer):
            base_model.resize_token_embeddings(32032)
